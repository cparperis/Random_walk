...
tracks_doc = open('/Users/Christopher/Documents/Code/Python/Monte Carlo Diffusion/AuNPs_Tracks.xml')
xml_tracks_doc = minidom.parse(tracks_doc)
...
printNode(xml_tracks_doc.documentElement)
